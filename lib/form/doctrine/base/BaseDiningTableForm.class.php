...
/**
 * DiningTable form base class.
 *
 * @method DiningTable getObject() Returns the current form's model object
 *
 * @package    yfoodnet
 * @subpackage form
 ...
 */
abstract class BaseDiningTableForm extends BaseFormDoctrine
{
